              ...
              <tr>
                <td style="padding:0 0 18px;line-height:0;">
                  <a href="${permalink}" target="_blank" style="display:block;">
                    <img src="${imgSrc}" alt="${alt}" width="520" height="293" style="display:block;width:100%;max-width:520px;height:auto;aspect-ratio:16/9;object-fit:cover;border:0;border-radius:8px;" />
                  </a>
                </td>
              </tr>`
    : "";
