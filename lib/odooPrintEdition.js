...
// Paid Stripe subscriber variant of the print edition record. Same Odoo
// endpoint, tagged so the team can tell it apart from the waitlist.
export async function sendPrintSubscriptionToOdoo({
  fullName,
  email,
  phone,
  addressLine1,
