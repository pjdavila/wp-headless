...
async function toRow(record, origin) {
  return {
    ...
    recommendation1Name: record.recommendation1?.originalName || "",
    recommendation1Url: await fileUrl(record.recommendation1, origin),
    recommendation2Name: record.recommendation2?.originalName || "",
    recommendation2Url: await fileUrl(record.recommendation2, origin),
    recommendation3Name: record.recommendation3?.originalName || "",
    recommendation3Url: await fileUrl(record.recommendation3, origin),
